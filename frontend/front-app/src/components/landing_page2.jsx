...
const LandingPage = () => {
  ...
  return (
    <div className="landing-page">
      ...
      <Link to='/service'className='Estimate px-4 py-2 flex bg-black text-stone-200 rounded-lg text-lg text-center '>Get an instant Estimate <IoIosArrowRoundUp className='rotate-45 text-4xl py-1'/></Link>
      <Link to =''><button className='Signup px-4 py-2 flex border border-black text-black rounded-lg text-lg text-center'>Explore Design Packages <IoIosArrowRoundUp className='rotate-45 text-4xl py-1'/></button></Link>
      </div>
...
<section className="how-it-works h-screen w-full bg-stone-200 flex items-center justify-center">
  <div className="w-full text-center p-8">
    ...
    <div className="mt-12">
    <Link to='/service' className="bg-black text-white px-4 py-2 rounded-lg ">Start with an Initial Estimate</Link>
